...
> 멋쟁이사자처럼 클라우드 엔지니어링 부트캠프 6기 최종 프로젝트 심사 1등작입니다.
...
- **김동재** (본인): 백엔드 전체(주문 접수 API·매칭 엔진·트레이더·기록기 등) 주도 개발, 인프라 설계 참여
- **양지훈** (부팀장): 인프라 설계 주도, 인프라 관리 담당
- **김다현**: 프론트엔드 개발 주도, 인프라 관리 참여
